...
public class TesteConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2020-06-19T19:53:07Z"),OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2020-06-20T15:08:52Z"),OrderStatus.SHIPPED, u2);
		Order o3 = new Order(null, Instant.parse("2020-06-21T20:32:45Z"),OrderStatus.DELIVERED, u1);
		...
		Payment pay1 = new Payment(null,Instant.parse("2020-06-19T21:53:07Z"), o1);
		o1.setPayment(pay1);
